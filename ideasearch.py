...
if not openai_api_key:
    st.error("OpenAI API key not found in secrets. Please set the API key in the Streamlit secrets management.")
    st.stop()
if not google_api_key or not google_cse_id:
    st.error("Google API key or Custom Search Engine ID not found in secrets. Please set them in the Streamlit secrets management.")
    st.stop()
...
st.write("This AI tool helps you generate insights and analyze business opportunities.")
...
if st.button("🔍 Generate Analysis and Ideas"):
    if problem and barrier and affected and wish:
        try:
            ...
            st.write("### 📌 Problem Summary with Insights")
            ...
            st.write("### 🌍 Market Potential Analysis")
            ...
            st.write("### 🚧 Major Challenges to Solve")
